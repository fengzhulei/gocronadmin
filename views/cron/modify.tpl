            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="cron_add" method="post" action="/cron/modify">
                            {{if .err_info}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="stime" name="stime" class="form-control layer-date"  value='{{date .Stime "Y-m-d H:i:s"}}'  type="text" placeholder="YYYY-MM-DD hh:mm:ss" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">结束时间：</label>
                                <div class="col-sm-8">
                                    <input id="etime" name="etime" class="form-control layer-date" value='{{date .Etime "Y-m-d H:i:s"}}' type="text" placeholder="YYYY-MM-DD hh:mm:ss" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <label class="checkbox-inline">
                                        <input name="singleton" type="radio" value="1" {{if .Singleton}}checked{{end}} >是</label>
                                    <label class="checkbox-inline">
                                        <input name="singleton" type="radio" value="0" {{if not .Singleton}}checked{{end}} >否</label>
                                </div>
                            </div>
                            <div class="form-group">
